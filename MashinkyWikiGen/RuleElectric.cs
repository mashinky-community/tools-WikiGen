...
{
    /// <summary>
    /// Represents an electric production rule for buildings that require electricity to operate.
    /// Electric rules are used when a building needs electrification to function.
    /// </summary>
    public class RuleElectric : IRule
    {
        ...
        /// <summary>
        /// Initializes a new instance of the RuleElectric class.
        /// </summary>
        ...
        public RuleElectric(Token input1Type, int input1Count, Token input2Type, int input2Count, Token input3Type, int input3Count, Token output1Type, int output1Count, Token output2Type, int output2Count, Token output3Type, int output3Count)
        {
